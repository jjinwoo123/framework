...
<div class="container">
				...
				<div class="container-fluid">
			    	...
			    	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      	<ul class="nav navbar-nav">
				        	...
				        	<li class="active"><a href="/sts02/emp/list.bit">EMP</a></li>
	...
	<div class="row">
	  	<div class="col-md-12">
	  	<p class="text-right"><a class="btn btn-primary" href="add.bit" role="button">입력</a></p>
			<div class="list-group">
				...
				<a href="#" class="list-group-item">
					...
					<h4 class="list-group-item-heading">${bean.sabun } - ${bean.name } </h4>
  					<p class="list-group-item-text"><fmt:formatDate value="${bean.nalja }" pattern="YYYY/MM/dd hh:mm" var="nal"/>${nal}</p>
				</a>
 				</c:forEach>
			</div>
		</div>
